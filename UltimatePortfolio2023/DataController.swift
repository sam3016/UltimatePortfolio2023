...
/// An environment signleton responsible for managing our Core Data stack, including handling saving
...
class DataController: ObservableObject {
    ...
    var suggestedFilterTokens: [Tag] {
        ...
        if trimmedFilterText.isEmpty == false {
            request.predicate = NSPredicate(format: "name CONTAINS %@", trimmedFilterText)
        }
    ...
    /// tag, title, and context, search tokens, priority, and completion status.
    ...
    func hasEarned(award: Award) -> Bool {
        ...
        default:
            ...
            // fetalError("Unknown award criterion: \(award.criterion)")
            return false
        }
    }
}
